...
curl -b cookies.txt -c cookies.txt --data "event-name=HackLondon&channel-name=food" http://localhost:1337/api/user/channel 
curl -b cookies.txt -c cookies.txt --data "event-name=HackLondon&channel-name=general" http://localhost:1337/api/user/channel 
